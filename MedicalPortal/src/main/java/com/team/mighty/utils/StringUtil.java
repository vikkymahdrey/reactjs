...
public class StringUtil {
	...
	private static MightyLogger logger = MightyLogger.getLogger(StringUtil.class);
	 ...
	 */
	public static String converClobToString(Object obj) throws MightyAppException {
		...
		try{
			...
			throw new MightyAppException(e);
		}finally{
			if(null != br){
				try {
					br.close();
