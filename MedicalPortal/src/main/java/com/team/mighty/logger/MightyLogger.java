 ...
 *
 */
public class MightyLogger {

	private final Logger logger;
	
	public static MightyLogger getLogger(Class<?> cls) {
		return getLogger (cls.getName());
	}
	
	public static MightyLogger getLogger(String pkgName) {
		return new MightyLogger(Logger.getLogger(pkgName));
	}
	
	private MightyLogger(Logger logger) {
		this.logger = logger;
	}
