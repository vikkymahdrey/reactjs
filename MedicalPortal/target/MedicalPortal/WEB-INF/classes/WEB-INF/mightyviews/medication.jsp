		...
		<div className="container">	
			...
			<div className="row">
				...
				<div className="breadcrumb-wrap">
					...
					<a href="allergiesInfo" ><b>Allergies </b></a>
...
<div id="medication"></div>
	...
	String fname1=("Medication:").concat(new Date().toString()).concat(".csv");
	String fname2=("Medication:").concat(new Date().toString()).concat(".xls");
	String fname3=("Medication:").concat(new Date().toString()).concat(".xml");
	List<Medication> medicationInfo=(List<Medication>)request.getAttribute("medicationInfo");
	%>
				<div id="display">
				
		 <display:table class="alternateColor" name="<%=medicationInfo%>" id="row"
			export="true" requestURI="" defaultsort="1" defaultorder="descending" pagesize="10">
				<display:column  property="id" title="ID" sortable="true" headerClass="sortable" />
							
				<display:column   property="medicationName" title="Medication_Name" sortable="true" headerClass="sortable" />
				
				<display:column   property="medicationType" title="Medication_Type" sortable="true" headerClass="sortable"/>
